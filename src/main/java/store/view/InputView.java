...
public class InputView {
    ...
    public String readPurchaseNonPromotionProducts() {
        return readLine(NON_PROMOTION_NOTICE.getMessage());
    }

    public String readAddFreeProducts() {
        return readLine(FREE_ITEM_PROMPT.getMessage());
    }
